...
- [Core Architecture](guides/core-architecture.md) — System design, data flow, and module interactions.
- [CLI Usage](guides/cli-usage.md) — Command-line interface options, flags, and execution modes.

### Judges

- [Judges](guides/judges.md) — Evaluation criteria, abstention logic, and custom judge implementation.
- [Judge Validation](guides/judge-validation.md) — Meta-evaluation techniques to verify judge reliability and bias.
- [Cross-Judge Validation](guides/cross-judge-validation.md) — Comparing judge outputs and validating consistency across evaluators.

### Scenarios

- [Scenarios](guides/scenarios.md) — Test case definitions, domain-specific packs, and scenario creation guidelines.

### Results & Tooling

- [Results & Analysis](guides/results-analysis.md) — Data structures, result aggregation, and statistical analysis.
- [Visualization](guides/visualization.md) — Interactive dashboard server and result exploration tools.

### Advanced

- [Reframing & Advanced Workflows](guides/reframing-advanced-workflows.md) — Prompt reframing strategies and complex experimental setups.
...
- [`simpleaudit.scenarios.images.make_images`](reference/simpleaudit_scenarios_images_make_images.md) — 
...
- [`simpleaudit.visualization.server`](reference/simpleaudit_visualization_server.md) — FastAPI visualization server: browse audit results in a browser.
